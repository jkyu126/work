...
response = response %>% filter(class=="6월 19일") %>% select(-class)
...
pf = pf %>% 
  ...
  select(time, team1, team2, team3, team4, team5, team6, team7, team8, team9, team10) 
```

## 팀별 포트폴리오 비율 공개
```{r, echo = F}
reveal %>%
  select(symbol, team1, team2, team3, team4, team5, team6, team7, team8, team9, team10) %>%
  kable() %>%
